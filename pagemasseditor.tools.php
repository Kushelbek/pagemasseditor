...
if ($a == 'update')
{
	$rpage_id = cot_import('rpageid', 'P', 'ARR');
	...
	if (is_array($rpage_id))
	{
		foreach ($rpage_id as $id => $titlev)
		{
...
foreach ($sqllist_rowset as $pag)
{
	...
	$t->assign(array(
		...
		'PAGEEDIT_FORM_IDHIDDEN' => cot_inputbox('hidden', 'rpageid[' . $id . ']', $pag['page_id']),
